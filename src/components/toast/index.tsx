      ...
      <div className="w-96 mb-4">
        ...
        >
          <div className="flex w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            {closable && (
                <button onClick={() => setShow(false)} className="px-4 py-2 text-gray-600 dark:text-gray-200 hover:text-gray-800 dark:hover:text-gray-400 hover:bg-gray-100 hover:cursor-pointer">
                  &times;
                </button>
            )}
          </div>
